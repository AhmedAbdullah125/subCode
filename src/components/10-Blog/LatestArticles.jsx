      ...
      <div className={`absolute inset-0 bg-gradient-to-br ${isDarkMode ? 'from-gray-950 via-gray-900 to-gray-950 opacity-50' : 'from-gray-50 via-white to-gray-50 opacity-70'}`} />
      {
        isLoading ? <CardSkeleton count={3} />
          ...
          <div className="relative container mx-auto px-4">
            ...
            {/* Articles Grid */}
            <motion.div {...animations.stagger} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
            ...
            >
              ...
              >
                ...
                <ArrowRight
                  className={`w-5 h-5 transition-transform ${currentLang === 'ar'
